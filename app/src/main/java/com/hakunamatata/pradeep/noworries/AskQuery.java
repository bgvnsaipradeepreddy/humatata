    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    queryData = jsonUtility.constructJSONQuery(data);
                ...
                requestPackage.setUri("http://192.168.42.49:8080/noworries/webapi/queries/insertnewquery");
 ...
 */
    ...
    private class AskQueryThread extends AsyncTask<RequestPackage,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(AskQuery.this,"Query has been successfully posted",Toast.LENGTH_LONG).show();
            finish();
